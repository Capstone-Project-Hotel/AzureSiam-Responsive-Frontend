...
export default function Footer() {
    return(
        <div className="flex flex-row w-[100vw] h-[18vh] px-[4.16vw] items-center " style={{ backgroundColor: '#2A4D69', color: 'white' }} >
            ...
            <Link href="/"><p className="text-[16px] font-sans ml-[50vw] mt-[11vh]">Contact Us</p></Link>
        </div>
    )
}